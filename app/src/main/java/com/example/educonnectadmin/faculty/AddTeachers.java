...
public class AddTeachers extends AppCompatActivity {
   ...
   private Button addTeacherBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Principal","Vice-Principal","Mathematics", "Social Science", "Computer Science","Physics","Chemistry","Biology","Junior Science","English","Hindi","Regional Language","Arts","Music","Physical education","Librarian"};
